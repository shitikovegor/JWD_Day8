...
import static com.shitikov.task6.dataprovider.LibraryData.BOOK_5;
...
public class CommandDataProvider {
    ...
    public static Object[] createSortByPublishingHouse() {
        ...
        Map<String, List<Book>> sortedResponse = new HashMap<>();
        sortedResponse.put("Books sorted by publishing house", sortedBooks);
    ...
    public static Object[] createSortByPages() {
        ...
        Map<String, List<Book>> sortedResponse = new HashMap<>();
        sortedResponse.put("Books sorted by number of pages", sortedBooks);
