...
public class LibraryControllerTest {
    ...
    public Object[][] createData() {
        ...
        Book bookForCheck = new BookBuilder()
                ...
                .buildPages(710)
                .buildBook();
        bookForCheck.setBookId(6);
        List<Book> booksWithNew = createExpectedList();
        booksWithNew.add(bookForCheck);
        ...
        addExpected.put("Book added to library", booksWithNew);

        Map<String, List<Book>> removeExpected = new HashMap<>();
        removeExpected.put("Book removed from library", expectedBooks);
        ...
        byPublHouseExpected.put("Books sorted by publishingHouse", sortedByPublHouse);
        ...
        byPagesExpected.put("Books sorted by pages", sortedByPages);
        ...
        Map<String, List<Book>> findAllExpected = new HashMap<>();
        findAllExpected.put("Books found", allBooks);
        ...
        return new Object[][]{{"add book", bookParameters, addExpected},
                ...
                {"find all", new HashMap<>(), findAllExpected},
